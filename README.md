# AgentAz™ — open-source AI-agent governance + 62 reference blueprints
...
- **Score** any agent's governance — paste a system prompt or an `agentaz.json` into the free, deterministic [AgentAz Compliance Scanner](https://www.agent-kits.com/scan); it returns pass/fail gates mapped to Microsoft’s published governance guidance, plus a fix-list.
