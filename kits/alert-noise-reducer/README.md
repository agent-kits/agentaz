...
Run it live in your browser (your own API key): https://www.agent-kits.com/kit/alert-noise-reducer#run-live · Score any agent against Microsoft’s guidance: https://www.agent-kits.com/scan
