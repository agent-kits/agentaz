...
Run it live in your browser (your own API key): https://www.agent-kits.com/kit/nda-triage-agent#run-live · Score any agent against this rubric: https://www.agent-kits.com/scan
