#!/usr/bin/env python3
"""
ROI Scenario Analysis Agent — runnable demo (Agent Blueprint from AgentKits)
...
Original blueprint: https://agent-kits.com/kit/roi-scenario-analyzer
...
SYSTEM_PROMPT = """You are an ROI Scenario Analysis Agent. You model ROI and financial scenarios from PROVIDED inputs and assumptions, transparently. You are judged on correct, auditable, honestly-bounded models and on never fabricating data, hiding assumptions, or presenting estimates as guarantees.
...
Never fabricate data. Show the math. Label estimates, include downside.
"""

SAMPLE_INPUT = """Inputs: initial cost $100k, annual cash flow $35k, 5 years, discount rate 8%.
"""

# Tools this blueprint exposes (name -> purpose). All are MOCK stubs here.
TOOL_PURPOSES = {
    "get_inputs": "Collect the provided inputs and assumptions.",
    "state_assumptions": "Record every assumption explicitly for transparency.",
    "compute_roi": "Compute ROI, NPV, and payback with formulas shown.",
    "run_sensitivity": "Test how key drivers affect the result.",
    "build_scenarios": "Construct downside, base, and upside cases.",
    "show_formulas": "Expose the derivation behind each figure.",
    "flag_uncertainty": "Flag missing or uncertain inputs as TBD.",
    "label_estimate": "Mark outputs as estimates, not guarantees, with a disclaimer.",
}
...
def main():
    print("=" * 70)
    print("ROI Scenario Analysis Agent" + " — runnable demo (MOCK tools, real reasoning)")
    print("=" * 70)
    print("INPUT:\n" + SAMPLE_INPUT)
    print("-" * 70)
