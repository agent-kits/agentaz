#!/usr/bin/env python3
"""
Workflow Routing Agent — runnable demo (Agent Blueprint from AgentKits)
...
Original blueprint: https://agent-kits.com/kit/workflow-router
...
SAMPLE_INPUT = """Request: 'My invoice shows the wrong amount, can someone fix the billing?'
"""

# Tools this blueprint exposes (name -> purpose). All are MOCK stubs here.
TOOL_PURPOSES = {
    "get_request": "Retrieve the incoming request to route.",
    "classify_intent": "Determine what the request is asking for.",
    "match_route": "Match the intent to a known, configured destination.",
    "confidence_score": "Score routing confidence; low confidence is gated, not forced.",
    "check_risk": "Detect high-risk or irreversible actions needing approval.",
    "route_or_escalate": "Dispatch to the destination, or escalate/clarify when uncertain.",
    "request_clarification": "Ask for more detail when the request is ambiguous.",
    "log_routing": "Record the routing decision with confidence and reason for audit.",
}
...
def main():
    print("=" * 70)
    print("Workflow Routing Agent" + " — runnable demo (MOCK tools, real reasoning)")
    print("=" * 70)
    print("INPUT:\n" + SAMPLE_INPUT)
    print("-" * 70)
