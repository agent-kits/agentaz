#!/usr/bin/env python3
"""
Community Question Triage Agent — runnable demo (Agent Blueprint from AgentKits)
...
Original blueprint: https://agent-kits.com/kit/community-question-triager
...
SAMPLE_INPUT = """Member: 'How do I reset my API key?'
"""

# Tools this blueprint exposes (name -> purpose). All are MOCK stubs here.
TOOL_PURPOSES = {
    "get_post": "Retrieve the incoming community post and its context.",
    "safety_filter": "Detect spam, harassment, hate, harmful content, and distress before any answer is considered.",
    "classify_topic": "Categorize a safe post by area for matching and routing.",
    "detect_duplicate": "Find an existing answered thread the post duplicates.",
    "kb_search": "Search the knowledge base and prior answers for a grounded response.",
    "draft_answer": "Compose a sourced answer with a citation when confidence is high.",
    "route_to_human": "Route uncovered or low-confidence questions to the right human team.",
    "escalate_moderation": "Send abuse to moderators and crisis/self-harm signals to a person immediately.",
}
...
def main():
    print("=" * 70)
    print("Community Question Triage Agent" + " — runnable demo (MOCK tools, real reasoning)")
    print("=" * 70)
    print("INPUT:\n" + SAMPLE_INPUT)
    print("-" * 70)
