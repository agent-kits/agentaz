...
Run it live in your browser (your own API key): https://www.agent-kits.com/kit/task-capture-organizer#run-live · Score any agent against Microsoft’s guidance: https://www.agent-kits.com/scan
